...
| 3. Make sure that your Expansion Hub is turned on and powered by a charged 12V battery and that the Robot Controller phone is connected to the Expansion Hub through a USB connection.  Note that the Robot Controller does **not ** need to have the Expansion Hub included in an active configuration file in order for the update to work.<br/><br/><p align="center">[[/images/Configuring-Your-Hardware/ConfiguringHardwareStep4.jpg]]</p>|
