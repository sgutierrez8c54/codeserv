...
**Important note:** At this point, although you have created your configuration file, you have not yet saved its contents to the robot controller.  In a [subsequent tutorial](https://github.com/FIRST-Tech-Challenge/ftc_app/wiki/Configuring-Your-Hardware#configuring-a-digital-touch-sensor), you will save the configuration file in a later step.
